...
// Yunwu AI 服务密钥
const DEFAULT_YUNWU_TOKEN = 'sk-BNkrD8Sfje36v0dbgVQDIVmfE8F4NV9A06zG9btQx9I1fwf5'
 ...
 */
export function buildGeminiYwRequestBody(imageBase64s: string[], prompt: string): GeminiYwRequestBody {
