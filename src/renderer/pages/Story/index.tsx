...
const getStoryImageParamConfig = (model: string): StoryImageParamConfig => {
  ...
  if (model === RUNNINGHUB_GPT_IMAGE2_MODEL) {
    return {
      ...
      aspectRatioValues: STORY_RUNNINGHUB_GPTIMAGE2_SIZE_VALUES,
      resolutionValues: STORY_RUNNINGHUB_GPTIMAGE2_RESOLUTION_VALUES,
    };
  }
...
const normalizeGrok2ApiMediaUrl = async (url: string) => url;
