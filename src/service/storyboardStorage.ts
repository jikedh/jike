...
export const DEFAULT_SPLIT_SYSTEM_PROMPT =
  [
    ...
    "输出必须像真人短剧拍摄分镜，重点不是解释人物设定，而是把每个镜头的景别、视角、运镜、人物位置关系、前景/中景/远景关系写清楚。",
    "最终只输出分镜正文。格式如下：分镜1：0–2s 景别，视角，运镜。画面自然语言描述。分镜2：2–5s 景别，视角，运镜。画面自然语言描述。",
    "禁止输出：生成段落标题、变量统筹、场景设定、听觉设计、段尾衔接、分析、解释、表格、CHOS标签、“无音乐、无字幕、无画面文字”",
