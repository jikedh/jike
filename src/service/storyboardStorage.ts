...
export const DEFAULT_SPLIT_SYSTEM_PROMPT =
  [
    ...
    "只输出 JSON 对象，不要 Markdown、表格、标题、解释或总结。结构必须是：{ \"shots\": [{ \"script\": \"该段对应的原文剧本文字，按原文顺序保留对白、VO、OS和关键动作，不要摘要\", \"prompt\": \"谢凌霜是@谢凌霜，顾砚臣是@顾砚臣，谢凌霜的声音是@谢凌霜音色，顾砚臣的声音是@顾砚臣音色，场景是@王府长廊夜景\\n\\n分镜1：0–3s\\n\\n中景，正面平视，固定镜头。画面自然语言描述。\\n\\n分镜2：3–6s\\n\\n过肩中景，谢凌霜背后视角，固定镜头。画面自然语言描述。\", \"assets\": { \"role\": [\"本段涉及的角色名\"], \"scene\": [\"本段涉及的场景名\"], \"prop\": [\"本段涉及的道具名\"], \"audio\": [\"本段涉及的音频资产名，可为空数组\"] } }] }。"
  ].join("\n");
