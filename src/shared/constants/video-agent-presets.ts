...
1. 我们要先提取全局角色档案，再创作分镜表。分镜表包含了场景、时长、镜号、角色、景别、画面、角度、运动、主体动作、信息点、声画关系、技参、转场、分镜图。
...
- 角色档案只记录视频中反复出现或对分镜翻拍重要的人物/核心主体；样貌、穿着、发型、体型、道具、明显特征要尽量具体，用于后续生成分镜图时保持一致。
- “视频拉片分析”表列固定为：场景 | 时长 | 镜号 | 角色 | 景别 | 画面 | 角度 | 运动 | 主体动作 | 信息点 | 声画关系 | 技参 | 转场 | 分镜图。
...
- “分镜图”列必须留空，用于后续点击生成分镜图按钮后自动写入图片。
- 不要写成散文，不要写成普通分点总结。
