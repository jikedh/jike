  ...
  const features = [
    {
      id: 'canvas',
      title: '无限画布',
      description: '可视化节点编辑器。连接 AI 代理与多模态模型，自由编排您的工业级影视工作流。',
      icon: SquareDashedMousePointer,
    },
    {
      id: 'script',
      title: '剧本生成',
      description: '由 AI Agent 驱动。从一句话灵感扩展为完整故事板、分镜脚本与影视级提示词序列。',
      icon: Type,
    },
    {
      id: 'assets',
      title: '资产库',
      description: '中心化资产管理。高效存储、分类和搜索您所有生成的图像、视频素材与角色模型。',
      icon: Folder,
    },
    {
      id: 'voice',
      title: '情感配音合成',
      description: '深度情绪控制。为您的角色注入灵魂，生成具有好莱坞质感的多语言对白与音效。',
      icon: Mic,
    },
  ] as const
        ...
        <div className="mb-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            {creativeProjects.map((project) => (
              <div key={project.id} className="group flex cursor-default flex-col gap-3">
