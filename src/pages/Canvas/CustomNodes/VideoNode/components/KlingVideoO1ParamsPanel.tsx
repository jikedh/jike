...
type KlingVideoO1ParamsPanelProps = {
    ...
    // 更新参考视频列表
    onVideoListChange?: (value: { video_url?: string; refer_type?: string; keep_original_sound?: string }[]) => void
}
                            ...
                            <div className="space-y-4 pl-1">
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-medium text-neutral-400 flex items-center gap-1.5">
                                        <IconVideo size={12} />
                                        参考视频 URL
                                        <span className="text-[10px] text-neutral-500 ml-1">最多1段视频</span>
                                    </label>
                                    <div className="flex gap-2">
                                        <Input
                                            type="text"
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="flex gap-2">
                                                    {REFER_TYPE_OPTIONS.map((item) => {
                                                        const isActive = (currentVideo.refer_type ?? 'base') === item.value
                                                        return (
                                                            <button
                                                                key={item.value}
                                                                type="button"
                                                                onClick={() => handleReferTypeChange(item.value)}
                                                                className={cn(
