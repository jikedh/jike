      ...
      >
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-neutral-300">生成模式</label>
          ...
          {/* 画面比例 */}
          <div className="space-y-2">
            <label className="text-xs font-medium text-neutral-300">画面比例</label>
          ...
          {/* 分辨率 */}
          <div className="space-y-2">
            <label className="text-xs font-medium text-neutral-300">视频分辨率</label>
            <div className="flex gap-2">
          ...
          <div className="flex items-center justify-between rounded-lg border border-neutral-700 bg-neutral-800/50 p-3">
            <div>
              <label className="text-xs font-medium text-neutral-300">生成音频</label>
