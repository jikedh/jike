...
import { getTextAgentPresetById, getTextAgentPresetLabelById } from '@/constants/text-agent-presets'
...
export const TextAgentNode = memo(({ id, data, selected }: NodeProps<TextAgentNodeType>) => {
  ...
  const presetLabel = preset ? getTextAgentPresetLabelById(presetId) : '文本智能体'
