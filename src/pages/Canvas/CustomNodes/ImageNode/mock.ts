...
export const COMMAND_MOCK = [
    ...
    { id: 'c-4', label: 'VR图', command: '/vr', description: '基于参考图精准转换为720° 无缝球形全景图，构建 360° 水平 + 360° 垂直完整环绕空间，全景衔接自然无撕裂、无拼接痕迹、光影统一、透视合理、细节清晰、分辨率高清、画质细腻，符合球形全景投影规范，可直接用于 VR / 全景展示。比例为21:9' },
] as const
