...
export const COMMAND_MOCK = [
    ...
    { id: 'c-3', label: '多宫格电影分镜', command: '/character-multiple-grid', description: '参考我上传的图片，生成不同的拍摄角度，每一张图片的中间是用白色分割线区分的,[1. 极度特写镜头], [2. 四分之三侧面照], [3. 侧面照], [4. 背影], [5. 高角度镜头], [6. 低角度镜头], [7. 广角全身照], [8. 低角度特写], [9. 高角度广角镜头]' },
    { id: 'c-4', label: 'VR图', command: '/vr', description: '基于参考图精准转换为720° 无缝球形全景图，构建 360° 水平 + 360° 垂直完整环绕空间，全景衔接自然无撕裂、无拼接痕迹、光影统一、透视合理、细节清晰、分辨率高清、画质细腻，符合球形全景投影规范，可直接用于 VR / 全景展示。' },
] as const
