 ...
 * @returns 最接近的标准比例值
 */
export function getClosestAspectRatio(imageWidth: number, imageHeight: number): string {
 ...
 * @returns 节点宽度和高度
 */
export function getNodeSizeByAspectRatio(aspectRatio: string, baseHeight: number = 250): { width: number; height: number } {
