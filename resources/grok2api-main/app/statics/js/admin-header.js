window.renderAdminHeader = async function renderAdminHeader() {
  ...
  const HEADER_HTML_CACHE_KEY = `grok2api.admin_header_html.${scriptVersion}.model.nav3`;
    ...
    mount.innerHTML = `
      <header class="admin-header">
        <div class="admin-header-inner">
          ...
          <nav class="admin-nav">
            <a href="/admin/account" class="admin-nav-link" data-nav="/admin/account" data-i18n="header.account">Grok 账户</a>
            <a href="/admin/model" class="admin-nav-link" data-nav="/admin/model" data-i18n="header.model">模型管理</a>
            <a href="/admin/config" class="admin-nav-link" data-nav="/admin/config" data-i18n="header.config">系统设置</a>
            <a href="/admin/cache" class="admin-nav-link" data-nav="/admin/cache" data-i18n="header.cache">缓存与日志</a>
          </nav>
